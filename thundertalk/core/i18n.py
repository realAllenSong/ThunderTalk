...
_STRINGS: dict[str, dict[str, str]] = {
    ...
    "review.rewriting": {"en": "CORRECTING…", "zh": "修正中…"},
    "review.rewrite_label": {"en": "GRAMMAR FIX", "zh": "语法修正"},
    ...
    "settings.llm_rewrite.desc": {
        "en": "Use a local LLM to silently fix grammar and punctuation after transcription.",
        "zh": "转录后用本地小模型静默修正语法与标点，不影响粘贴速度。",
    },
    "settings.llm_rewrite.model_label": {
        "en": "Correction Model", "zh": "修正模型",
    },
    "settings.llm_rewrite.model_hint": {
        "en": "HuggingFace model ID (mlx-community/Qwen2.5-*-Instruct-*bit recommended)",
        "zh": "HuggingFace 模型 ID，推荐 mlx-community/Qwen2.5-*-Instruct-*bit",
    },
